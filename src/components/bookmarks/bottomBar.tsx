...
import { FaChevronRight, FaRegFolder } from "react-icons/fa";
...
const BottomBar = () => {
  ...
  return (
    <form className={styles.bottom_bar} onSubmit={(e) => create(e)}>
      ...
      <button
        ...
        className={`${styles.is_folder_button} ${
          isFolder ? styles.is_folder_selected : ""
        }`}
        onClick={(e) => {
          e.preventDefault();
      ...
      <button aria-label="Add New Bookmark" className={styles.submit_button}>
        <FaChevronRight />
      </button>
    </form>
  );
